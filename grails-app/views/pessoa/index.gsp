		...
		<div id="list-pessoa" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="identidade" title="${message(code: 'pessoa.identidade.label', default: 'Identidade')}" />
				...
				<g:each in="${pessoaInstanceList}" status="i" var="pessoaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: pessoaInstance, field: "identidade")}</td>
